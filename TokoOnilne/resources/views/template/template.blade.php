    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Tugas</b>pemweb</span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <small>Member until Nov. 2069</small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/students"><i class="fa fa-circle-o"></i>Data Mahasiswa</a></li>
                <li><a href="/students/create"><i class="fa fa-circle-o"></i>Tambah Mahasiswa</a></li>
              </ul>
            </li>
        </section>
        <!-- /.sidebar -->
